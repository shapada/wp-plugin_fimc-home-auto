...
class Core {
	...
	public function __construct() {
		$this->page_templater = new PageTemplater::get_instance;
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style(
			'fimc-vendor-core', 
			FIMC_ABSURL . "/assets/css/fimc-vendor-core{$min}.css",
			array(),
			FIMC_VERSION
		);
		...
		wp_enqueue_style(
			'fimc-core', 
			FIMC_ABSURL . "/assets/css/fimc-core{$min}.css",
			array(),
			FIMC_VERSION
		);
		wp_enqueue_style(
			'fimc-fa',
			FIMC_ABSURL . "/assets/fonts/css/font-awesome.min.css"
		);
	}
}